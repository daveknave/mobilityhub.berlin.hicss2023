...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('services', '0020_auto_20211211_1049'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services_blogpagetag_items', to='taggit.tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='datensatz',
            name='tags',
            field=modelcluster.contrib.taggit.ClusterTaggableManager(blank=True, help_text='A comma-separated list of tags.', through='services.BlogPageTag', to='taggit.Tag', verbose_name='Tags'),
        ),
    ]
